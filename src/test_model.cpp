...
int main() {
    ...
    cv::Ptr<cv::ml::ANN_MLP> mlp = cv::ml::ANN_MLP::load("/media/work/train/readmnist/MNIST_train_model.xml");

    // Load the image you want to classify
    cv::Mat testImage = cv::imread("/media/work/train/sample_imgs/2.png", cv::IMREAD_GRAYSCALE);  // Assuming the image is grayscale
